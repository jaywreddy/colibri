...
- **Great Vibes** (`backend/app/patterns/motifs/fonts/GreatVibes-Regular.ttf`) —
  copyright TypeSETit, LLC, released under the SIL Open Font License 1.1
  (`OFL.txt` and `LICENSE_NOTE.md` beside the font). Used to set the J+P monogram silhouette; the
...
The photographs under `backend/app/assets/photos/` are personal and are not
licensed for reuse.
