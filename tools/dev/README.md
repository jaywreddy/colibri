...
| `prep_bitmap.py` | Prepare a photograph as a halftone-ready bitmap asset under `backend/assets/bitmaps/`. `uv run --directory backend python ../tools/dev/prep_bitmap.py ../my-photo.jpg portrait-flores --crop 0.44,0.14,0.46 --steps 22` |
